...
const ja: Messages = {
  // Block Kit: 収集中
  'collecting.blocks': '🐿️ *{{channelCount}}チャンネル* から :{{emoji}}: を収集中... しばらくお待ちください',
  'collecting.fallback': '🐿️ {{channelCount}}チャンネルから :{{emoji}}: を収集中...',
  // Block Kit: 完了
  'completion.header': '収集完了',
  'completion.body': '✅ *{{count}}件* のメッセージを収集しました\n\n📄 <{{canvasUrl}}|Canvasを確認>',
  'completion.fallback': '✅ {{count}}件のメッセージを収集しました 📄 Canvas: {{canvasUrl}}',
  ...
  // Block Kit: ロック競合
  'lock.conflict': '⏳ 現在 :{{emoji}}: の収集が実行中です\nしばらく待ってから再度お試しください',
  'lock.conflictFallback': '⏳ 現在 :{{emoji}}: の収集が実行中です',
  // コマンドパーサーエラー
